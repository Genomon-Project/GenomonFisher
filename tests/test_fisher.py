...
class TestFisher(unittest.TestCase):
    ...
    def test1(self):
        ...
        positions_bed = None
        is_anno = True
        mismatch_rate_disease_base0 = 0.07
        fisher_threshold_base0 = 0.5
        ...
        mismatch_rate_disease_base0, fisher_threshold_base0
        )
    ...
    def test2(self):
        ...
        positions_bed = None
        is_anno = True
        mismatch_rate_disease_base0 = 0.02
        fisher_threshold_base0 = 0.4
        fisher.Pileup_and_count(in_bam1, in_bam2, sample1, sample2, out_file, ref_fa,
        baseq_thres, mismatch_rate_disease, mismatch_rate_normal, post_10_q,
        fisher_threshold, min_depth, header_flag, min_variant_read, samtools,
        samtools_params, region, region_file, positions_bed, is_anno, True,
    ...
    def testa(self):
        ...
        sample1 = "5929_tumor"
        sample2 = "5929_control"
        out_file =  cur_dir + "/../data/5929_small_mutation_result_testa.txt"
        ref_fa  = cur_dir + "/../data/GRCh37.fa"
        baseq_thres = 15
        mismatch_rate_disease = 0.02
        mismatch_rate_normal = 0.1
        ...
        positions_bed = None
        is_anno = True
        mismatch_rate_disease_base0 = 0.03
        fisher_threshold_base0 = 0.4
        fisher.Pileup_and_count(in_bam1, in_bam2, sample1, sample2, out_file, ref_fa,
        baseq_thres, mismatch_rate_disease, mismatch_rate_normal, post_10_q,
        fisher_threshold, min_depth, header_flag, min_variant_read, samtools,
        ...
        answer_file = cur_dir + "/../data/5929_small_mutation_result_answer_testa.txt"
        self.assertTrue(filecmp.cmp(out_file, answer_file, shallow=False))
    ...
    def testb(self):
        ...
        sample1 = "5929_tumor"
        sample2 = "5929_control"
        out_file =  cur_dir + "/../data/5929_small_mutation_result_testb.txt"
        ref_fa  = cur_dir + "/../data/GRCh37.fa"
        baseq_thres = 15
        mismatch_rate_disease = 0.02
        mismatch_rate_normal = 0.1
    ...
    def test29(self):
        ...
        sample1 = "5929_tumor"
        sample2 = "5929_control"
        out_file =  cur_dir + "/../data/5929_small_mutation_result_test29.txt"
        ref_fa  = cur_dir + "/../data/GRCh37.fa"
        baseq_thres = 15
        mismatch_rate_disease = 0.02
        mismatch_rate_normal = 0.1
        ...
        answer_file = cur_dir + "/../data/5929_small_mutation_result_answer_test29.txt"
        self.assertTrue(filecmp.cmp(out_file, answer_file, shallow=False))
    ...
    def test2a(self):
        ...
        sample1 = "5929_tumor"
        sample2 = "5929_control"
        out_file =  cur_dir + "/../data/5929_small_mutation_result_test2a.txt"
        ref_fa  = cur_dir + "/../data/GRCh37.fa"
        baseq_thres = 15
        mismatch_rate_disease = 0.02
        mismatch_rate_normal = 0.1
    ...
    def test41(self):
        ...
        args = parser.parse_args(["comparison", "-1", in_bam1, "-2", in_bam2, "-a", sample1, "-b", sample2, "-o", out_file, "-r", ref_fa, "-s", samtools, "-S", samtools_params, "-Q", str(baseq_thres),  "-m", str(mismatch_rate_disease), "-M", str(mismatch_rate_normal), "-f", str(fisher_threshold), "-d", str(min_depth), "-v", str(min_variant_read), "-e", "--flag_mis_base_0"])
        args.func(args)
        self.assertTrue(filecmp.cmp(out_file, answer_file, shallow=False))
